...
export const PLATFORMS: Platform[] = [
  {
    ...
    strengths: ["Everyday tasks", "Summarizing", "Plugins & browsing"],
  ...
  },
  {
    ...
    strengths: ["Coding", "Long-form writing", "Nuanced reasoning"],
    bestForIndividual: "When accuracy, code, and getting it right matters",
    bestForBusiness: "Engineering, research, analysis, and complex document work",
  },
  {
    id: "gemini",
    displayName: "Gemini",
    ...
    strengths: ["Multimodal (images, video)", "Google Workspace", "Research"],
  ...
  },
  {
    ...
    strengths: ["Speed", "Multilingual", "Privacy & open-source"],
    bestForIndividual: "Fast answers, privacy-conscious users",
    bestForBusiness: "European businesses, multilingual teams, compliance-sensitive orgs",
  },
  {
    id: "grok",
    displayName: "Grok",
    ...
    tagline: "The real-time thinker",
    strengths: ["Real-time web access", "Current events", "Math & reasoning"],
  ...
  },
  {
    ...
    strengths: ["Open source", "Self-hosting", "Customizability"],
    bestForIndividual: "Technically curious users who want full control",
